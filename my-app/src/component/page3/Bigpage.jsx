      ...
      <section style={styles.mainSection}>
        <div style={styles.diagonalTextContainer}>
          ...
          <div style={{ marginTop:'-15vh', backgroundColor: 'rgba(255, 255, 255, 0.5)', color: '#050f7c' }}>
            <div style={{ display: 'flex', gap: '20%' ,flexDirection: 'row', justifyContent: 'space-around', width: '90%', marginLeft: '7%', marginTop: '0%', flexWrap: 'wrap'}}>
        ...
        <div style={{ backgroundColor: 'white' }}>
          <div>
            ...
            <div style={styles.cardRow}>
              ...
              <RenderCard text='Inspection' imagePath='iStock-1128873458.jpg' description='Le technicien établira un rapport de la situation (type et taux d`infestation définira un protocole de traitement personnalisé  et un devis sera remis'/>
